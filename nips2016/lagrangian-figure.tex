...
region the remaining constraints. Where the blue region slopes downwards, 
a decrease in $M_{\good}$ can be offset by an increase in $M_{\bad}$ when 
measuring $\langle B, M \rangle$. By linearizing the nuclear norm constraint, 
the vector $B-Z$ accounts for this offset, 
and the red region represents the constraint 
$\langle B_{\good}-Z_{\good}, M^*_{\good} - M_{\good} \rangle \leq \epsilon$, which will contain $\M$.
}
\vskip 0.05in
