...
\draw (\ex,\X+0.08*\s) edge[dashed,red!70!black] node[pos=0.43,above,rotate=90,scale=0.68,red!50!black] {$\langle B_{\good}\!-\!Z_{\good}, M^*\!-\!M \rangle \leq \epsilon$} (\ex,\x-0.09*\s);
...
region the remaining constraints. Because the blue region slopes upwards, 
