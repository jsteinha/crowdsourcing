...
\end{align}
%$\|R\|_* = \sqrt{\frac{|\sC|}{|\sC|}}$ 
%that $\|R\|_* = \sqrt{\frac{|\sC|}{|\sD|}}$ while $\langle A, R \rangle = |\sC|$. Our goal 
%is to show that, unless $\|R_{\sC}-M_{\sC}\|_1 \leq \epsilon \alpha n$, $M$ cannot possibly 
%be the optimum of \eqref{eq:optimization-noiseless}. 
